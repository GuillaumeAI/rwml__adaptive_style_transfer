...
########################################################
#v2-dev-png
#@STCGoal That we know if PNG is a higher resolution for the server (an option in the request: outformat:<jpg|png>
...
inputs={'contentImage': runway.image,'x1':number(default=pass1_image_size,min=24,max=17000),'x2':number(default=pass2_image_size,min=24,max=17000),outformat:'jpg':text}
