...
for c in $chks ; do
	...
	export containername=inko03_s1a_$checkpointno
	...
	source custom-cli-start-script-docker-dev-specific-checkpoint-singleone.210606-nvidia.sh \
		$modelname \
		$serverhostport \
		$PASS1IMAGESIZE \
       		$checkpointno
